...
//
//@SpringBootTest
//class TiComoGp4ApplicationTests {
//
//
//	@Autowired
...
//			throws YaEnUsoException, ContraseniaIncorrectaException, IlegalNumberException, InvalidEmailException {
//		usuario = new Usuario("12345677", "Pablo", "hola@gmail.com", "8Caracteres", "8Caracteres", 5, "Ciudad Real", "623534253");
//		usuarioG = regService.signUpUsuario(usuario);
...
//			throws YaEnUsoException, ContraseniaIncorrectaException, IlegalNumberException, InvalidEmailException {
//		rider = new Rider("05985017A", "Pablo", "holaqueal@r.com", "8Caracteres", "8Caracteres", 5, "Audi", "14315FAS", "carnet","685345313");
//		try {
...
//			throws YaEnUsoException, ContraseniaIncorrectaException, IlegalNumberException, InvalidEmailException {
//		rider = new Rider("05985017A", "Pablo", "rider@rider.com", "12345678D", "12345678D", 5, "Audi", "14315FAS", "carnet","685345313");
//		riderG = regService.signUpRider(rider);
...
//			throws YaEnUsoException, ContraseniaIncorrectaException, IlegalNumberException, InvalidEmailException {
//		rider = new Rider("1235123S", "Pablo", "asdfasg@r.com", "1234", "FallaContraseñaSegunda", 1, "Audi", "14315FAS", "carnet","685345313");
//		try {
//			riderG = regService.signUpRider(rider);
//		} catch (ContraseniaIncorrectaException e) {
//			assertNull(riderG);
...
//		usuario = new Usuario("05985017A", "Pepito", "a@g.com", "1235673247A", "daigualloquepongas", 1, "ciu",
//				"634523566");
//		try {
...
//			InvalidEmailException, UnexistentUser, PerfilBloqueadoException, IncompleteFormException {
